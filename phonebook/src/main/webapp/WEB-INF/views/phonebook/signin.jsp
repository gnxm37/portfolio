...
<body>
               ...
               <div class="col-lg-8">
                  ...
                  <form method="post" action="/phonebook/in" enctype="multipart/form-data">
                     ...
                     <div class="form-outline mb-4">
                        <input type="text" name="userid" id="form3Example3" class="form-control" /> 
                     ...
                     <!-- Password input -->
                     <div class="form-outline mb-4">
                        <input type="password" name="userpassword" id="form3Example4" class="form-control" />
   ...
   <script type="text/javascript"
      ...
      ${msg}
   <script src="/images/10-10.jpg"></script>
</body>
</html>