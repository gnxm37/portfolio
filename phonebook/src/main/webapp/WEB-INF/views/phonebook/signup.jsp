...
<body>
	...
	<section class="text-center">
		...
		<div class="p-5 bg-image"
			style="background-image: url('/images/10-8.jpg'); height: 300px;"></div>
		<!-- Background image -->
				...
				<div class="row d-flex justify-content-center">
					<div class="col-lg-8">
						...
						<form method="post" action="/phonebook/up"
							...
							<div class="row d-flex justift-left-left">프로필 이미지</div>
							...
							<div class="form-outline mb-4">
								<input type="text" name="username" id="username"
									class="form-control" oninput="namecheck(username.value)" required /> <label class="form-label"
							...
							<p class="id_ok">멋진 아이디네요. 사용 가능한 아이디입니다.</p> 
							<p class="id_already">사용중인 아이디입니다.</p>
